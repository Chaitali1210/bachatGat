...
const AdminPanel = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA]">
            {/* Header Section */}
            <div className="bg-[#EDF1F7] px-4 py-2 ">
                <div className="flex flex-col sm:flex-row justify-between items-center m-8">
                    <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#2C3D83]">
                        Admin Panel
                    </h1>
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 w-full sm:w-auto mt-2 sm:mt-0">
                        <button
                            onClick={() => setShowAddCRPForm(true)}
                            className="bg-[#EA6E2E] text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg text-sm sm:text-base w-full sm:w-auto"
                        >
                            Register CRP
                        </button>
                        <button
            ...
            <div className="px-4 py-6 max-w-screen-xl mx-auto">
                ...
                {showCRPList && crpList.length > 0 && (
                    <div className="rounded shadow-[0px_0px_10px_1px_rgba(0,_0,_0,_0.1)] bg-white ">
